...
; 0000 0044 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(64)
	STS  124,R30
; 0000 0045 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(135)
	STS  122,R30
...
; 0000 004C CreateChar(3,PacMan4);
	...
	RCALL _CreateChar
; 0000 004D 
; 0000 004E PORTC.0 = 1; // PC0 con Pull-up
	SBI  0x8,0
; 0000 004F MoveCursor(5,0);
	RCALL SUBOPT_0x2
; 0000 0050 StringLCD("Hello");
; 0000 0051 MoveCursor(3,1);
; 0000 0052 StringLCD("Mr. PacMan");
; 0000 0053 
; 0000 0054 while (1)
_0x2D:
; 0000 0055 {
; 0000 0056 // Movimiento a la derecha
; 0000 0057 while(PINC.0 == 1){
_0x30:
	SBIS 0x6,0
	RJMP _0x32
; 0000 0058 MoveCursor(i,j);
	RCALL SUBOPT_0x3
; 0000 0059 CharLCD(0);
	LDI  R26,LOW(0)
	RCALL _CharLCD
...
_0x34:
	SBI  0x1E,0
_0x35:
; 0000 0063 MoveCursor(5,0);
	RCALL SUBOPT_0x2
; 0000 0064 StringLCD("Hello");
; 0000 0065 MoveCursor(3,1);
; 0000 0066 StringLCD("Mr. PacMan");
; 0000 0067 }
; 0000 0068 else
	RJMP _0x36
_0x33:
...
_0x32:
; 0000 006B 
; 0000 006C //Movimimento a la izquierda
; 0000 006D while(PINC.0 == 0){
_0x37:
	SBIC 0x6,0
	RJMP _0x39
; 0000 006E MoveCursor(i,j);   //Paso 1
	RCALL SUBOPT_0x3
; 0000 006F CharLCD(2);        //Paso 2
	LDI  R26,LOW(2)
	RCALL _CharLCD
; 0000 0070 DelayPacman();
	RCALL _DelayPacman
; 0000 0071 MoveCursor(i,j);   //Paso 3
	RCALL SUBOPT_0x3
; 0000 0072 CharLCD(3);        //Paso 4
	LDI  R26,LOW(3)
	RCALL _CharLCD
; 0000 0073 DelayPacman();
	RCALL _DelayPacman
; 0000 0074 MoveCursor(i,j);   //Paso 5
	RCALL SUBOPT_0x3
; 0000 0075 CharLCD(' ');      //Paso 6
	LDI  R26,LOW(32)
	RCALL _CharLCD
; 0000 0076 if(i==0){
	LDS  R30,_i
...
_0x3B:
	SBI  0x1E,0
_0x3C:
; 0000 0079 MoveCursor(5,0);
	RCALL SUBOPT_0x2
; 0000 007A StringLCD("Hello");
; 0000 007B MoveCursor(3,1);
; 0000 007C StringLCD("Mr. PacMan");
; 0000 007D }
; 0000 007E else
	RJMP _0x3D
_0x3A:
